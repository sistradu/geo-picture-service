...
\\
Bei der Erstellung eines neuen Albums werden natürlich auch Bilder hinzugefügt. Das Hochladen der Bilder erfolgt über eine Primafaces-Komponente die auf Seite \pageref{subsec:FileUpload} im Abschnitt \autoref{subsec:FileUpload} beschrieben wird. Diese Komponente braucht einen FileU
