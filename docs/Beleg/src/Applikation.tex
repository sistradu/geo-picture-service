...
\\
Um auf eine Bean zugreifen zu können muss sie zuerst aus dem FacesContext geholt werden. Dieses wurde in eine extra Methode ausgelagert, da sie an vielen Stellen benötigt wird. Zu sehen ist die Methode im Anhang im Listing \autoref{lstBeanzugriff} auf Seite \pageref{lstBeanzugriff}. Das geholte Objekt ist vom Typ Object so dass vor dem Aufruf einer Methode des Controllers noch ein Cast erforderlich ist. Ein Beispiel dazu ist auf Seite \pageref{lstBeanzugriffAufruf} im Listing \autoref{lstBeanzugriffAufruf} zu sehen.
