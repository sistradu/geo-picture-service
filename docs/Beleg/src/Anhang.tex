...
\begin{itemize}
	\item \textbf{Beleg}
	\begin{itemize}
		\item \textit{Beleg\_XML-Anwendungen\_Gruppe1\_GPicS.pdf} - dieses Dokument im PDF-Format
		...
		\end{itemize}
	\end{itemize}
	\item{\textbf{Quellcode}} - enthält den Quellcode des Projektes.
\end{itemize}
...
\label{JumpKlassendiagramme}

\begin{figure}[h!t]
	\begin{center}
		\includegraphics[width=\textwidth]{img/DB-Klassen.png}
		\caption{Das Klassendiagramm zu den Connector-Klassen}
		\label{JumpDBKlassenDiag}
	\end{center}
\end{figure}
...
\includepdf[pages=-, fitpaper=true]{img/SSDs.pdf}
...
\begin{lstlisting}[caption=Umsetzung des Singleton-Patterns für die Klasse DBConnector,label=JumpDBZugriffSingleton]
private DBConnector(){
...
\begin{lstlisting}[caption=Die Klasse NameValidator,label=JumpValidatorName]
...
<kml xmlns="http://earth.google.com/kml/2.0"><Response>
  ...
  <Placemark id="p1">
    <address>Obermarkt 17, 02826 Görlitz, Deutschland</address>
    <AddressDetails Accuracy="8" xmlns="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0"><Country><CountryNameCode>DE</CountryNameCode><CountryName>Germany</CountryName><AdministrativeArea><AdministrativeAreaName>Saxony</AdministrativeAreaName><SubAdministrativeArea><SubAdministrativeAreaName>Görlitz</SubAdministrativeAreaName><Locality><LocalityName>Görlitz</LocalityName><DependentLocality><DependentLocalityName>Görlitz</DependentLocalityName><Thoroughfare><ThoroughfareName>Obermarkt 17</ThoroughfareName></Thoroughfare><PostalCode><PostalCodeNumber>02826</PostalCodeNumber></PostalCode></DependentLocality></Locality></SubAdministrativeArea></AdministrativeArea></Country></AddressDetails>
    <ExtendedData>
...
\end{figure}
\begin{figure}[ht]
\includegraphics[width=\textwidth]{img/plakat_gpics.png}
\caption{Projektplakat}
\label{fig:projektplakat}
\end{figure}
