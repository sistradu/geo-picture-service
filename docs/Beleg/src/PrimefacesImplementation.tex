...
\end{lstlisting}
Das Hinzufügen der Marker und was bei einem Klick auf einem Marker passiert, muss in der dazu gehörigen ManagedBean erfolgen. Dies wird in Abschnitt \autoref{subsubsec:MapBean} noch erläutert.\\
\\
...
<p:galleria>
\end{lstlisting}
Damit die Bilder dynamisch angezeigt werden, muss noch im Controller eine Methode implementiert werden. Dies wird in Abschnitt \autoref{subsubsec:AlbumController} beschrieben.
