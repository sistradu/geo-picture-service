...
\end{enumerate}
eXist erfüllt alle diese Vorraussetzungen und tatsächlich gibt es kaum weitere native XML-Datenbanksysteme, die als Alternative in Frage kämen (vgl. \cite{BR02}). Im Folgenden sollen hier kurz 3 weitere Systeme, die noch näher betrachtet wurden, mit eXist verglichen werden.\\
